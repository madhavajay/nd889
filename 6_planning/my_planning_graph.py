...
class PlanningGraph():
    ...
    def add_literal_level(self, level):
        ...
        for actionNode in self.a_levels[level - 1]:
            ...
            for rem_effect in actionNode.action.effect_rem:
                ...
                actionNode.children.add(stateNode)
                level_nodes.append(stateNode)
        self.s_levels.append(set(level_nodes))
    ...
    def inconsistent_effects_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        return (
            set(node_a1.action.effect_rem) & set(node_a2.action.effect_add) or
    ...
    def interference_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        return (
            ...
            set(node_a2.action.precond_pos) & set(node_a1.action.effect_rem) or
            set(node_a2.action.precond_neg) & set(node_a1.action.effect_add)
        )
    ...
    def competing_needs_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        return (
            set(node_a1.action.precond_pos) & set(node_a2.action.precond_neg) or
    ...
    def h_levelsum(self) -> int:
        ...
        for level, nodes in enumerate(self.s_levels):
            ...
            for node in nodes:
                if len(goals) == 0:
                    break
                if node.symbol in goals and node.is_pos is True:
